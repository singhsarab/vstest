...
namespace Microsoft.VisualStudio.TestPlatform.Client.DesignMode
{
    ...
    public class DesignModeClient : IDesignModeClient
    {
        ...
        ProtocolConfig protocolConfig = new ProtocolConfig { Version = 1 };
                        ...
                        case MessageType.StartDiscovery:
                            {
                                ...
                                testRequestManager.DiscoverTests(discoveryPayload, new DesignModeTestEventsRegistrar(this), protocolConfig);
                                break;
                            }
